...
namespace HyperActive.SchemaProber.SqlCeExtensions
{
	...
	public class SqlServerCeProvider : IDbProvider
	{
		...
		public SqlServerCeProvider(IDbHelper helper)
		{
			_helper = helper;
		}

		private IDictionary<string, string> GetConstraints(string tableName)
		{
...
//			return result;
		...
		/// <returns></returns>
		public TableSchemaList GetAssociations(TableSchema table)
		{
